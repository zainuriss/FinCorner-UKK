                    ...
                    <form method="POST" action="{{ route('admin.films.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="">
                                ...
                                <x-text-input id="release_year" class="block mt-1 w-full" type="number"
                                    name="release_year" :value="old('release_year')" required autocomplete="release_year" />
                        ...
                        <div class="mt-4 flex flex-row gap-4">
                            <div class="w-1/2">
                                ...
                                <x-text-input id="poster" class="block mt-1 w-full py-1.5" type="file"
                                    name="poster" :value="old('poster')" />
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="poster_url" class="block mt-1 w-full" type="text" name="poster_url"
                                    :value="old('poster_url')" autocomplete="poster_url" />
                        ...
                        <div class="mt-4 flex flex-row gap-4">
                            <div class="w-1/2">
                                ...
                                <x-text-input id="trailer" class="block mt-1 w-full py-1.5" type="file"
                                    name="trailer" :value="old('trailer')" />
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="trailer_url" class="block mt-1 w-full" type="text" name="trailer_url"
                                    :value="old('trailer_url')" autocomplete="trailer_url" />

            ...
            <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 overflow-x-scroll">
                    <div class="flex justify-end gap-2">
                        <a href="{{ route('admin.casting_relations.index') }}" class="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded">
                                ...
                                <tr class="">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="gap-2 flex">
                                            <a href="{{ route('admin.casting_relations.restore', $dt->id) }}" class="bg-lime-600 hover:bg-lime-900 p-2.5 rounded">
                                                <x-fas-trash-restore class="w-4 h-auto"/>
                                            </a>
                                            <form action="{{ route('admin.casting_relations.destroy', $dt->id) }}" method="POST" class="inline" id="delete-form">
                                                @csrf
                                                @method('DELETE')

                                ...
                                <tr class="">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="gap-2 flex">
                                            <a href="{{ route('films.show', $g->id) }}" class="bg-indigo-600 dark:bg-indigo-400 hover:bg-indigo-900 dark:hover:bg-indigo-600 p-2.5 rounded">
                                                <i class="fa-solid fa-circle-info"></i>
                                            </a>
                                            <form action="{{ route('admin.films.destroy', $g->id) }}" method="POST" class="inline" id="delete-form">
                                                @csrf
                                                @method('DELETE')
